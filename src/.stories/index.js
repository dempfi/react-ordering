      ...
      render() {
        ...
        return (
          <Component
            ...
            itemSize={itemHeight == null ? index => items[index].height : itemHeight}
...
class VirtualizedListWrapper extends Component {
  render() {
    const { className, items, height, width, itemHeight, itemClass, isSorting } = this.props
    return (
      <List
        ref='VirtualList'
        className={className}
...
const SortableInfiniteList = SortableContainer(({ className, items, itemClass, isSorting }) => {
  return (
    <Infinite
      className={className}
      containerHeight={600}
...
const ShrinkingSortableList = SortableContainer(({ className, isSorting, items, itemClass, shouldUseDragHandle }) => {
  return (
...
const NestedSortableList = SortableContainer(({ className, items, isSorting }) => {
  return (
    <div className={className}>
...
storiesOf('General | Layout / Horizontal list', module).add('Basic setup', () => {
  return (
    <div className={style.root}>
      <ListWrapper
        component={SortableList}
    ...
    return (
      <div className={style.root}>
        <ListWrapper
          component={SortableList}
          items={getItems(50, 59)}
          outOfTheWayAnimationDuration={450}
          helperClass={style.stylizedHelper}
        />
      </div>
    )
    ...
    return (
      <div className={style.root}>
        <ListWrapper
          component={SortableList}
          items={getItems(50, 59)}
          outOfTheWayAnimationDuration={0}
          helperClass={style.stylizedHelper}
        />
      </div>
    )
...
storiesOf('Advanced examples | Virtualization libraries / react-tiny-virtual-list', module)
  .add('Basic setup', () => {
    return (
      <div className={style.root}>
        <ListWrapper
...
storiesOf('Advanced examples | Virtualization libraries / react-virtualized', module)
  .add('Basic setup', () => {
    return (
      <div className={style.root}>
        <ListWrapper
...
storiesOf('Advanced examples | Virtualization libraries / react-infinite', module)
  .add('Basic setup', () => {
    return (
      <div className={style.root}>
